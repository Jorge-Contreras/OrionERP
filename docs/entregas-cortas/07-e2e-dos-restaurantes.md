# Chat 07: Dos empresas de Restaurante sobre el mismo proyecto
...
Continúa OrionERP con este único incremento: **Dos empresas de Restaurante sobre el mismo proyecto**.

Objetivo orientativo: 45–90 min, 8–12k tokens incluyendo lecturas y salidas. Dependencias: chat 03 terminado o evidencia equivalente en main; chat 05 terminado o evidencia equivalente en main. Superficie de publicación: Bruno si hay correcciones.
...
Prepara dos empresas/sedes sintéticas de Restaurante en Sandbox, con dos procesos del mismo OrionERP.Bruno.Web. Prueba marca, publicación de menú y horarios, cuentas, membresía, recuperación, cookies/tokens y transición/reversión con dobles de correo/Turnstile.

## Límite de esta entrega

No crees proyectos por cliente ni nuevos clientes productivos. Mantén separado el restaurante propiedad de Bonhomía: no atribuirlo a Bruno por nombre de proyecto. Publica sólo correcciones verificadas para Bruno existente.

## Pruebas y aceptación

Mismo email en sitios distintos, recuperación y tokens cruzados, sesión ajena, cambio de RFC/SiteKey en request, módulo suspendido, menú privado nunca usado como fallback y configuración cruzada que no arranca.
