# Chat 08: Corrección trazable de los vínculos históricos
...
Continúa OrionERP con este único incremento: **Corrección trazable de los vínculos históricos**.

Objetivo orientativo: 30–60 min, 6–10k tokens incluyendo lecturas y salidas. Dependencias: ninguna entrega nueva; partir del main vigente. Superficie de publicación: Lote SQL de datos, condicionado a evidencia.
...
El usuario confirmó que los 288 vínculos OHM/BSU son errores históricos; esa decisión ya está resuelta. Revisa el estado vigente de Sandbox y reúne evidencia documental para relaciones correctas. Produce un manifiesto por ID original, relación propuesta, evidencia y motivo; separa casos demostrados y no resueltos. Prepara un corrector aditivo, transaccional e idempotente con preview y auditoría, aplicado primero a datos de prueba.

## Límite de esta entrega

No inventes el vínculo correcto, no cambies RFC de pagos, importes ni saldos y no elimines enlaces sólo para cuadrar reportes. Si la evidencia no determina la corrección, solicita únicamente esa información empresarial y conserva las exclusiones. El primer lote productivo tendrá máximo 25 relaciones demostradas y revisadas; los restantes se repiten en lotes con el mismo mecanismo.

## Pruebas y aceptación

Confirma precondiciones por fila, cero cambios en importes/cabeceras, detección de datos que cambiaron después del preview, atomicidad y segunda ejecución sin duplicación. Si no hay relaciones acreditadas, el resultado será un expediente pendiente, no una corrección ficticia.
