# Chat 09: Resolver los cuatro mappings Outlook
...
Continúa OrionERP con este único incremento: **Resolver los cuatro mappings Outlook**.

Objetivo orientativo: 30–60 min, 6–10k tokens incluyendo lecturas y salidas. Dependencias: ninguna entrega nueva; partir del main vigente. Superficie de publicación: Consola y lote de mappings.
...
Revisa docs/hospitality-calendar-sync-isolation-20260908.md. Identifica los cuatro mappings huérfanos vigentes por sus IDs y evidencia de reserva/calendario. Implementa una reparación o cuarentena explícita y auditada de los mappings locales, ligada a CompanyId/SiteId, sin adoptar eventos remotos por semejanza de texto.

## Límite de esta entrega

No borres ni modifiques eventos Outlook reales. Mantén Graph Calendar deshabilitado; su activación requiere buzón, identidad y calendarios verificados, y autorización específica de esa sincronización. No mezcles esta entrega con correo de los websites.

## Pruebas y aceptación

Prueba mapping válido, huérfano, reserva eliminada, empresa/sede ajenas e idempotencia. Sólo aplica correcciones locales cuya evidencia sea suficiente; deja motivo e IDs precisos de lo restante.
