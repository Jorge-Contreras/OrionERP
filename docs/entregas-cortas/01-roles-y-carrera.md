# Chat 01: Validación de roles y carrera pendiente
...
Continúa OrionERP con este único incremento: **Validación de roles y carrera pendiente**.

Objetivo orientativo: 30–60 min, 6–10k tokens incluyendo lecturas y salidas. Dependencias: ninguna entrega nueva; partir del main vigente. Superficie de publicación: Consola.
...
Lee docs/multiempresa-browser-smoke-20260908.md y docs/restaurant-production-scope-20260908.md. Completa en Sandbox la matriz pendiente de cuentas restringidas y revocación para selector de sede, OT, ubicaciones, compras, conteos y POS. Reutiliza fixtures y prueba un recorrido mínimo de creación/edición/eliminación por agregado con datos propios. Completa únicamente el orden inverso de la carrera proyecto/calendario en HospitalityProjectConcurrencyTests: edición o eliminación primero, vínculo después, con conexiones reales y bloqueo observado.

## Límite de esta entrega

Publica sólo correcciones reproducidas por estas pruebas. Si todo pasa, entrega evidencia y commit de pruebas; no reinicies producción para publicar pruebas. No reescribas permisos ni repitas el fixture RestaurantProductionScope ya aprobado.

## Pruebas y aceptación

Pruebas positivas/negativas por rol, cambio de empresa, revocación durante sesión y carrera commit/rollback. Ningún fixture residual.
