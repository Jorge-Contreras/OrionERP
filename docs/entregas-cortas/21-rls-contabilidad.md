# Chat 21: RLS del agregado contable
...
Continúa OrionERP con este único incremento: **RLS del agregado contable**.

Objetivo orientativo: 60–120 min, 10–16k tokens incluyendo lecturas y salidas. Dependencias: chat 12 terminado o evidencia equivalente en main; chat 13 terminado o evidencia equivalente en main; chat 17 terminado o evidencia equivalente en main; chat 18 terminado o evidencia equivalente en main; chat 19 terminado o evidencia equivalente en main. Superficie de publicación: Esquema y consola coordinados.
...
Agrega RLS fail-closed al agregado Transacciones/Registro_Contable, después de verificar que todos sus consumidores adaptados establecen el contexto. Considera adjuntos, CFDI, reportes, jobs y consumidores externos/VBA al inventariar dependencias, sin declarar migrados los que no lo están. Prepara la activación como un corte coordinado.

## Límite de esta entrega

No impongas propiedad exclusiva a cfdi.Comprobante. Primera entrega: las dos tablas del agregado contable. Adjuntos, CuentasContables y CFDI quedan como lotes posteriores explícitos con sus propios prompts generados al cerrar. Si un escritor externo sigue sin contexto, adapta ese consumidor o deja el paquete preparado; no habilites bypass por NULL.

## Pruebas y aceptación

Pruebas SQL con cuentas operativas: sin contexto cero acceso, A/B separados, escritura y bloqueos correctos, contabilización/outbox/reversa/reportes funcionan. Reversión compatible de esquema/código, sin deshabilitar RLS para recuperar binarios viejos.
