# Chat 17: Reversa contable y activación del ciclo
...
Continúa OrionERP con este único incremento: **Reversa contable y activación del ciclo**.

Objetivo orientativo: 60–90 min, 10–14k tokens incluyendo lecturas y salidas. Dependencias: chat 14 terminado o evidencia equivalente en main; chat 16 terminado o evidencia equivalente en main. Superficie de publicación: Consola y activación delimitada.
...
Completa Reversed y reversa vinculada a la póliza original: movimientos inversos, motivo, auditoría e identidad de operación. Conserva inmutable el asiento original. Integra corrección por reversa en la pantalla contable y activa el ciclo sólo para empresas/periodos con reglas aceptadas; las nuevas pólizas usan el contrato completo.

## Límite de esta entrega

No borres ni reescribas historia. Define la fecha/periodo permitido conforme a la política empresarial existente; si esa política es inaccesible, pregunta sólo esa decisión y deja la capacidad preparada sin activarla.

## Pruebas y aceptación

Reversa balanceada, no duplicable, empresa y periodo válidos, carrera de doble reversa, rechazo de edición del original y relaciones Original/Reversa completas. Confirma que no se activó ningún periodo histórico no aprobado.
