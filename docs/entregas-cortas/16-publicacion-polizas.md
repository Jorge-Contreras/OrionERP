# Chat 16: Publicación atómica e inmutabilidad de pólizas
...
Continúa OrionERP con este único incremento: **Publicación atómica e inmutabilidad de pólizas**.

Objetivo orientativo: 60–120 min, 12–18k tokens incluyendo lecturas y salidas. Dependencias: chat 12 terminado o evidencia equivalente en main; chat 15 terminado o evidencia equivalente en main. Superficie de publicación: Consola; capacidad inicialmente desactivada.
...
Implementa Draft y Posted con publicación atómica: periodo abierto, movimientos balanceados, empresa consistente y permisos específicos. Impide editar o borrar cabecera/movimientos Posted por cualquier escritor del agregado, con integridad en SQL además del servicio. Usa una transición explícita desde Blazor y control de concurrencia.

## Límite de esta entrega

No conviertas Estatus legacy ni todas las pólizas históricas en Posted. Publica inicialmente con activación deshabilitada para usuarios hasta que la reversa del chat 17 esté lista; los flujos legacy compatibles siguen operando. No impongas restricciones nuevas a consumidores sin adaptar.

## Pruebas y aceptación

Desbalance, periodo cerrado, empresa ajena y dos publicaciones concurrentes son rechazados correctamente; fallos intermedios revierten todo; no existe edición/borrado alterno de Posted. La capacidad desactivada no cambia la operación existente.
