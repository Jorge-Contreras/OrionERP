# Chat 03: Suspensión en producción, catálogo y trabajos de Restaurante
...
Continúa OrionERP con este único incremento: **Suspensión en producción, catálogo y trabajos de Restaurante**.

Objetivo orientativo: 45–75 min, 8–12k tokens incluyendo lecturas y salidas. Dependencias: chat 02 terminado o evidencia equivalente en main. Superficie de publicación: Consola.
...
Revisa RestaurantProductionService, RestaurantCatalogService.GetSiteOperations/SaveSiteOperations y los trabajos de Restaurante realmente registrados. Cierra las guardas faltantes de empresa/módulo/sede y revalidación antes de escribir o despachar trabajo. Comprueba los recorridos alternos ya protegidos sin rehacerlos.

## Límite de esta entrega

Máximo tres consumidores que aún carezcan de guarda por ejecución. Si aparecen más, registra nombres exactos y genera el siguiente prompt sólo para ese lote. Nunca presentes ese primer lote como autorización transversal terminada.

## Pruebas y aceptación

Reutiliza las cinco integraciones de producción/prioridades. Agrega únicamente casos de suspensión/revocación y trabajo directo que falten; confirma que no se consumen ni pierden mensajes al suspender.
