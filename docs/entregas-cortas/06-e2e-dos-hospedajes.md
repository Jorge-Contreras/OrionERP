# Chat 06: Dos empresas de Hospedaje sobre el mismo proyecto
...
Continúa OrionERP con este único incremento: **Dos empresas de Hospedaje sobre el mismo proyecto**.

Objetivo orientativo: 45–90 min, 8–12k tokens incluyendo lecturas y salidas. Dependencias: chat 01 terminado o evidencia equivalente en main. Superficie de publicación: Bonhomía si hay correcciones.
...
Prepara dos empresas/sedes sintéticas habilitadas en Sandbox y dos instancias de OrionERP.Bonhomia.Web. Reutiliza el proyecto, perfiles públicos y configuración privada aislada. Prueba marca, disponibilidad, cotización/reserva con proveedor inerte, documentos, versiones legales y transición/reversión de presentación.

## Límite de esta entrega

El segundo cliente es exclusivamente sintético de Sandbox; no aprovisiones Los Patos ni nuevos dominios/clientes productivos. No copies proyectos. Publica únicamente correcciones encontradas que beneficien a la instancia existente.

## Pruebas y aceptación

Intentos cruzados de IDs, RFC y SiteKey en requests no cambian el alcance; host ajeno rechazado, configuración cruzada no arranca, módulos suspendidos bloquean operaciones y keyrings/tokens quedan separados.
