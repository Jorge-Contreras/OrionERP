# Chat 05: Cuenta SQL mínima para el website de Restaurante
...
Continúa OrionERP con este único incremento: **Cuenta SQL mínima para el website de Restaurante**.

Objetivo orientativo: 45–90 min, 8–12k tokens incluyendo lecturas y salidas. Dependencias: chat 04 terminado o evidencia equivalente en main. Superficie de publicación: Bruno.
...
Aplica a OrionERP.Bruno.Web una identidad SQL operativa exclusiva con permisos mínimos verificados en Sandbox: binding, catálogo publicado, Identity, membresía, cookies y recuperación usando dobles. Reutiliza el mecanismo operativo del chat 04, manteniendo usuarios SQL distintos por instancia. La cuenta de migración no debe aparecer en la configuración pública.

## Límite de esta entrega

No otorgues permisos generales de escritura a Restaurante/POS ni acceso a Hospedaje para resolver errores. Publica únicamente Bruno; conserva sus credenciales Graph/Turnstile existentes sin activar envíos de prueba reales.

## Pruebas y aceptación

Cuenta propia permite los flujos públicos y rechaza datos administrativos, DDL y otra instancia; prueba índices/FKs/triggers de Identity con la cuenta real, no sólo con login administrador.
