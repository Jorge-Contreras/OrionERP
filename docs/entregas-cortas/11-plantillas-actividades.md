# Chat 11: Plantillas estructuradas y actividades de reservas
...
Continúa OrionERP con este único incremento: **Plantillas estructuradas y actividades de reservas**.

Objetivo orientativo: 45–90 min, 8–14k tokens incluyendo lecturas y salidas. Dependencias: chat 10 terminado o evidencia equivalente en main. Superficie de publicación: Consola.
...
Delimita plantillas y referencias de actividades por CompanyId/SiteId, usando IDs comprobables de proyectos, habitaciones/calendarios y responsables. Habilita CreateActividadForReservation sólo si todas las asociaciones requeridas se pueden validar en la misma operación. Incorpora un flujo Blazor mínimo para configurar esos IDs reutilizando pantallas existentes.

## Límite de esta entrega

Mantén bloqueada la importación libre por texto y CreateTransaccionesForRoom. No infieras cuentas, categorías ni propietarios a partir de nombres. Si faltan mappings empresariales, entrega configuración funcional y conserva el bloqueo únicamente para esas asociaciones incompletas.

## Pruebas y aceptación

Reserva propia y plantilla válida producen una actividad; ausencia, referencias ajenas, suspensión y doble ejecución no dejan actividad inválida o duplicada. Revalida referencias dentro de la transacción.
