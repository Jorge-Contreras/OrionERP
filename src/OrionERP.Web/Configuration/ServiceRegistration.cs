...
public static class ServiceRegistration
{
  ...
  public static IServiceCollection AddOrionServices(this IServiceCollection services)
  {
    ...
    services.AddScoped<IAttendanceRecorder, AttendanceRecorder>();
    services.AddScoped<IWorkforceConfigurationService, WorkforceConfigurationService>();
    services.AddScoped<IAttendanceService, AttendanceService>();
    services.AddScoped<IKioskAttendanceService, KioskAttendanceService>();
    services.AddScoped<ILeaveManagementService, LeaveManagementService>();
    services.AddScoped<IPrenominaService, PrenominaService>();
    services.AddScoped<IPrenominaExportService, PrenominaExportService>();
    services.AddScoped<IWorkforceMaintenanceService, WorkforceMaintenanceService>();
    services.AddHostedService<WorkforceMaintenanceHostedService>();
    ...
    services.AddScoped<IRestaurantDeliveryService, RestaurantDeliveryService>();
    services.AddScoped<IOnlineOrderImportProcessor, RestaurantOnlineOrderImportProcessor>();
    services.AddScoped<IOnlineRestaurantOrderingAdminService, RestaurantOnlineOrderingAdminService>();
    ...
    services.AddScoped<IReservationAccountingService, ReservationAccountingService>();
    services.AddScoped<ContabITransaccionService, ContabTransaccionService>();
    services.AddHttpClient<IFacturamaApiClient, FacturamaApiClient>();
    services.AddScoped<ICfdiStampingService, CfdiStampingService>();
    services.AddScoped<CfdiReadableParser>();
