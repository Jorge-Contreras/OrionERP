# Chat 14: Conciliación del baseline contable
...
Continúa OrionERP con este único incremento: **Conciliación del baseline contable**.

Objetivo orientativo: 30–60 min, 6–10k tokens incluyendo lecturas y salidas. Dependencias: chat 12 terminado o evidencia equivalente en main; chat 13 terminado o evidencia equivalente en main. Superficie de publicación: Expediente y herramienta de validación.
...
Obtén un baseline actual de Sandbox para periodos, pólizas, sumas, desbalances y duplicados relevantes al ciclo contable. Prepara las consultas equivalentes productivas de sólo lectura y un manifiesto auditable de clasificación histórica, con evidencia por caso y reglas propuestas. No reutilices cifras antiguas como conteos actuales. Identifica decisiones empresariales concretas necesarias para adoptar Posted y cierres.

## Límite de esta entrega

No contabilices automáticamente toda la historia ni corrijas diferencias para igualar totales. No crees una nueva UI si bastan consultas y un expediente. Esta entrega no necesita reiniciar servicios; la aceptación empresarial del baseline es un dato de entrada, no algo que el agente pueda inventar.

## Pruebas y aceptación

Resultados reproducibles por empresa/periodo, detalle que explica cada agregado y reconciliación entre pólizas y reportes actuales. Deja aprobadas y pendientes claramente separadas para los chats 15–20.
