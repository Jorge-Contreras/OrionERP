# Chat 15: Periodos y guardas de cierre contable
...
Continúa OrionERP con este único incremento: **Periodos y guardas de cierre contable**.

Objetivo orientativo: 45–90 min, 8–12k tokens incluyendo lecturas y salidas. Dependencias: chat 12 terminado o evidencia equivalente en main; chat 14 terminado o evidencia equivalente en main. Superficie de publicación: Consola y esquema aditivo.
...
Implementa periodos contables por empresa y la guarda de periodo abierto para el agregado de pólizas, distinta de fiscal.DeclaracionCierre. Cubre cierre concurrente con escritura y permisos específicos en la pantalla mínima existente. Conserva un modo compatible para datos históricos todavía no conciliados.

## Límite de esta entrega

No cierres periodos históricos ni cambies su condición por defecto sin baseline aceptado. La migración crea capacidad; la activación se limita a empresas/periodos preparados. No mezcles impuestos declarativos con cierre del libro.

## Pruebas y aceptación

Escritura permitida en abierto, denegada en cerrado, aislamiento A/B y carrera real cierre/escritura sin operación aceptada después del cierre. Reapertura, si existe, exige permiso y auditoría.
