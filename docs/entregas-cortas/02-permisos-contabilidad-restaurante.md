# Chat 02: Suspensión en contabilidad de Restaurante
...
Continúa OrionERP con este único incremento: **Suspensión en contabilidad de Restaurante**.
...
Revisa RestaurantAccountingService y sus puntos de entrada inmediatos. Usa CompanyModule y SiteCapability para impedir preview, generación y otras operaciones contables originadas en Restaurante cuando su módulo/sede esté suspendido o no pertenezca a la sesión. Conserva disponible ACCOUNTING_CORE. Reutiliza las guardas existentes y revalida antes de cada mutación.

## Límite de esta entrega

No cambies todavía el ciclo de pólizas ni la bandeja contable. Alcance máximo: este servicio y sus llamadores necesarios.

## Pruebas y aceptación

Prueba módulo habilitado/suspendido, cambio después de abrir pantalla, sede ajena y acceso directo al servicio; suspensión no escribe ni elimina datos.
