...
| Producción y operaciones de sede — `Restaurante/RestaurantProductionService.cs`, `RestaurantCatalogService.cs` | Workspace/plan/fuentes/salida y prioridades de Location | Guardas de RFC sesión y árbol visible implementadas. Continuación desde main: fixture propio `HospitalityRestaurantProductionScopeTests`, 5/5 SQL aprobadas con/sin lotes, fuentes/destino, ciclo completo, reintentos, prioridades originales y otra sede del mismo RFC. [Evidencia](restaurant-production-scope-20260908.md). |
