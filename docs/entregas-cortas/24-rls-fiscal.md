# Chat 24: Retirar bypass RLS fiscal por agregado
...
Continúa OrionERP con este único incremento: **Retirar bypass RLS fiscal por agregado**.

Objetivo orientativo: 45–90 min, 8–14k tokens incluyendo lecturas y salidas. Dependencias: chat 13 terminado o evidencia equivalente en main. Superficie de publicación: Esquema y consola coordinados.
...
Revisa fiscal.RfcSecurityPolicy y consumidores; adapta el primer agregado autocontenido y activa predicados específicos que fallen cerrado sin contexto. Conserva el contrato de CFDI emisor/receptor y las distinciones entre declaración fiscal y cierre contable. Identifica exactamente las tablas y procedimientos incluidos.

## Límite de esta entrega

No edites ni incluyas el cambio ajeno 20260907_fiscal_declaracion_deploy.ps1. No cierres declaraciones, timbres CFDI ni cambies cálculos fiscales. No desactives de golpe el bypass de las seis tablas si no está demostrada compatibilidad de todos sus consumidores.

## Pruebas y aceptación

Contexto ausente/ajeno denegado, operación propia e integraciones del agregado funcionan; ningún CFDI compartido legítimo se pierde por una asociación equivocada. Deja continuaciones exactas para tablas que falten.
