    ...
    [
        ...
        new(
            ...
            [
                ...
                new("/restaurante/entregas", "Repartos", "Asignación, ruta y comprobación de entregas a domicilio.", "oi-map-marker", "Repartos a domicilio", NavLinkMatch.Prefix, true, "Ruta", "repartidor", "domicilio", "entregas"),
                ...
                new("/restaurante/mermas", "Merma", "Baja de producto caducado, dañado o no vendido, con evidencia y reversa.", "oi-trash", "Merma de inventario", NavLinkMatch.Prefix, true, "Baja", "merma", "mermas", "caducidad", "desperdicio", "baja", "tirar", "basura"),
                ...
                new("/restaurante/promociones", "Promociones y membresías", "Reglas, códigos, membresías, puntos y desempeño comercial.", "oi-tags", "Promociones y membresía", NavLinkMatch.Prefix, false, "Club", "promociones", "códigos", "fidelidad", "puntos"),
                new("/restaurante/sitio-publico", "Sitio público", "Contenido, contacto, redes, SEO y banderas del sitio del restaurante.", "oi-globe", "Sitio público del restaurante", NavLinkMatch.Prefix, false, "Web", "sitio", "seo", "redes"),
